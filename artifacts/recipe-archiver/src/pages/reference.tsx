              ...
              <div className="mb-5">
                <Input placeholder="Search ingredients…" value={search}
                  ...
                  style={{ border: `2px solid ${c.black}`, borderRadius: 0,
                    backgroundColor: "#FFF9EB", color: c.ink, fontFamily: "'Outfit', sans-serif" }} />
              </div>
              <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "0.68rem",
                textTransform: "uppercase", letterSpacing: "0.12em", color: c.ink,
                  ...
                  <LabelFrame key={cat.label}>
                    ...
                    <div style={{ backgroundColor: c.teal, padding: "0.3rem 0.85rem",
                      ...
                      <h2 style={{ fontFamily: "'Outfit', sans-serif", fontSize: "0.6rem", fontWeight: 700,
                        textTransform: "uppercase", letterSpacing: "0.25em", color: c.cream }}>
                        {cat.label}
                      </h2>
                    </div>
                ...
                {filteredChart.length === 0 && (
                  <p className="text-center py-8"
                    style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: "italic",
                      fontSize: "1rem", color: c.ink, opacity: 0.5 }}>
            ...
            <div>
              ...
              {showForm && (
                <form onSubmit={handleSubmit}
                  style={{ border: `2px solid ${c.black}`, backgroundColor: c.parch,
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button type="button" size="sm" variant="ghost"
                      ...
                      style={{ color: c.ink, fontFamily: "'Outfit', sans-serif", borderRadius: 0 }}>
                      Cancel
                    </Button>
                  </div>
                </form>
                  ...
                  <div style={{ border: `2px solid ${c.black}`, borderTop: "none" }}>
                    {filteredUserSubs.map((sub, i) => (
                      <div key={sub.id} className="flex gap-3 items-start"
                        ...
                        <button onClick={() => deleteMutation.mutate(sub.id)} title="Delete" style={{ flexShrink: 0, marginTop: 3 }}>
