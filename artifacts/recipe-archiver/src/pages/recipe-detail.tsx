...
// Per-banner: shape data (raw SVG string + the two hex codes that form the
// main ribbon face and its darker back/fold), curve + sm+ overhang placement.
type Banner = {
  raw: string;
  mainHex: string;
  backHex: string;
      ...
      <div className="container mx-auto px-4 py-10 max-w-4xl">
        <LabelFrame variant={6}>
          ...
          <div className="relative overflow-visible px-4 sm:px-8 py-6 sm:min-h-[320px]"
            ...
            {/* Banner: in-flow on mobile (full width, no overhang), per-banner overhang placement on sm+ via CSS vars. */}
            {(() => {
