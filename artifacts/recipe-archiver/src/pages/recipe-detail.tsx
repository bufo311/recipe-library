    ...
    <Layout>
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="flex justify-between items-start mb-8 gap-4 flex-wrap">
          <div>
            {recipe.category && (
              <Badge variant="secondary" className="mb-4 font-normal tracking-wide uppercase text-xs">{recipe.category}</Badge>
            )}
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This action cannot be undone. This will permanently delete your saved recipe.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  <AlertDialogCancel>Cancel</AlertDialogCancel>
                  <AlertDialogAction className="bg-destructive text-destructive-foreground hover:bg-destructive/90" onClick={() => deleteRecipe.mutate({ id: recipe.id })}>
            ...
            <ol className="space-y-8 text-foreground/90">
              {recipe.instructions.map((instruction, idx) => (
                <li key={idx} className="flex gap-6">
                  <span className="font-serif text-3xl text-primary/30 font-medium shrink-0 pt-0.5 select-none">
