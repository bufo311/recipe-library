      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <FormField control={form.control} name="category" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input placeholder="e.g. Dessert, Dinner" {...field} /></FormControl>
                <FormMessage />
              </FormItem>
            )} />
          </div>
                ...
                <FormItem>
                  <div className="flex items-center gap-2">
                    ...
                    <Button type="button" variant="ghost" size="icon" onClick={() => {
                      ...
                      if (ingredients.length > 1) form.setValue("ingredients", ingredients.filter((_, i) => i !== index));
                    }}>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 flex gap-2">
                      ...
                      <Button type="button" variant="ghost" size="icon" onClick={() => {
                        ...
                        if (instructions.length > 1) form.setValue("instructions", instructions.filter((_, i) => i !== index));
                      }}>
                        <Trash2 className="h-4 w-4 text-muted-foreground hover:text-destructive transition-colors" />
                      </Button>
                    </div>
        ...
        <div className="space-y-6">
          ...
          <FormField control={form.control} name="notes" render={({ field }) => (
            <FormItem>
              <FormControl><Textarea placeholder="Any additional notes, tips, or variations..." className="min-h-[120px]" {...field} /></FormControl>
              <FormMessage />
            </FormItem>
          )} />
        </div>
